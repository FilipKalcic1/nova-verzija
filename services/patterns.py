...
def detect_intent(query: str) -> QueryIntent:
    """
    Detect user intent using ML classifier (single source of truth).

    Version 3.0: Uses only ML model (100% accuracy on training set).
    Removed redundant keyword lists - ML classifier handles all cases.
    """
    from services.intent_classifier import detect_action_intent, ActionIntent
