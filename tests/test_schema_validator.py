...
class TestSchemaValidator:
    ...
    def test_remove_ref(self, validator):
        ...
        # $ref is removed as unsupported
        assert "$ref" not in result
        # Falls back to string type when no other type info
    ...
    def test_create_openai_function_basic(self, validator):
        ...
        result = validator.create_openai_function(
            name="get_Vehicles",
    ...
    def test_empty_schema(self, validator):
        """Empty schema should be handled - defaults to string type."""
        result = validator.validate_and_fix({})
        # Empty dict is treated as unknown type, defaults to string
        assert result == {"type": "string"}

    def test_none_schema(self, validator):
        """None schema should be handled - defaults to string type."""
        result = validator.validate_and_fix(None)
        # None is treated as unknown type, defaults to string
        assert result == {"type": "string"}
