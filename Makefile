.PHONY: help test lint format check run run-worker run-admin docker-up docker-down migrate coverage clean
...
coverage: ## Run tests with coverage report
	pytest tests/ -v --tb=short --cov=services --cov=config --cov-report=term-missing --cov-fail-under=40
